...
const MissionBriefing = ({ visible, onRegister }: MissionBriefingProps) => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[100dvh] flex items-center justify-center px-4 sm:px-6 pt-2 sm:pt-8 pb-8 overflow-hidden"
    >
      <motion.div
        initial={{ opacity: 0 }}
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center justify-center text-center gap-8 sm:gap-10">
        ...
        >
          <motion.button
            ...
            onClick={onRegister}
            className="group relative flex w-full items-center justify-center overflow-hidden rounded-full border border-cyan-400/50 bg-[radial-gradient(circle_at_top_left,#22d3ee_0,#1d1530_40%,#020617_85%)] px-5 py-1.5 sm:py-2 font-mono text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.32em] text-white shadow-[0_18px_40px_rgba(0,0,0,0.9)]"
          >
            <motion.span
              aria-hidden
